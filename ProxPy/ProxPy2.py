            ...
            for event in events_rd:
                ...
                if event == our_proxy_socket:
                    ...
                    for sock_to_rcv in sockets_rd:
                        if sock_to_rcv != our_proxy_socket and sock_to_rcv is event and is_in_the_list(output_conn,sock_to_rcv):
                            ...
                            if data:
                                ...
                                remove_conn(output_conn_request_reply, sock_to_rcv)

                        #To manage request from web nav. connections 
                        elif sock_to_rcv != our_proxy_socket and sock_to_rcv is event and is_in_the_list(input_conn,sock_to_rcv):
